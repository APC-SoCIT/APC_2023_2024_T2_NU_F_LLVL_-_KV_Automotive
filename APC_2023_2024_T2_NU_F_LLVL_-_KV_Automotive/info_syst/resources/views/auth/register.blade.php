        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            @if (Laravel\Jetstream\Jetstream::hasTermsAndPrivacyPolicyFeature())
                <div class="remember-forgot">
                    <label><input type="checkbox" name="terms">I agree to the <a target="_blank" href="{{ route('terms.show') }}">Terms of Service</a> and <a target="_blank" href="{{ route('policy.show') }}">Privacy Policy</a></label>
                </div>
            @endif
...
<style>
    /* Your existing styles for the wrapper, input-box, remember-forgot, btn, and register-link */
    *{
  margin: 0;
  padding: 0;
    ...
    document.addEventListener("DOMContentLoaded", function() {
            ...
            showPasswordIcons.forEach(icon => {
                icon.addEventListener("click", function() {
                    ...
                    // Toggle between hide and show icons
                    showPasswordIcons.forEach(icon => {
